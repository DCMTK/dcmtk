 ...
 *
 *  Purpose: Basic work list management service call provider based on the
...
#define OFFIS_CONSOLE_APPLICATION "wlmscpki"

int main( int argc, char *argv[] )
{
  // Initialize object which provides a connection to the data source
  WlmDataSourcePkiFile *dataSource = new WlmDataSourcePkiFile ();

  // Initialize and provide service. After having terminated free memory.
  WlmConsoleEngine *consoleEngine = new WlmConsoleEngine( argc, argv, DATA_SOURCE_IS_PKI_FILE, OFFIS_CONSOLE_APPLICATION, dataSource );
