 ...
 */
class DCMTK_DCMRT_EXPORT DRTAssigningAgencyOrDepartmentCodeSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTAssigningAgencyOrDepartmentCodeSequence(const DRTAssigningAgencyOrDepartmentCodeSequence &copy);
