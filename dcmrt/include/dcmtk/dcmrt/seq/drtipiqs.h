...
#include "dcmtk/dcmrt/seq/drtafs.h"    // for AssigningFacilitySequence
#include "dcmtk/dcmrt/seq/drtajcs.h"   // for AssigningJurisdictionCodeSequence


/** Interface class for IssuerOfPatientIDQualifiersSequence (0010,0024)
 */
class DCMTK_DCMRT_EXPORT DRTIssuerOfPatientIDQualifiersSequence
  : protected DRTTypes
{
  ...
  public:
      ...
      : protected DRTTypes
    {
      ...
      // --- get DICOM attribute values ---
        ...
        /** get IdentifierTypeCode (0040,0035)
         *  @param  value  reference to variable in which the value should be stored
         *  @param  pos    index of the value to get (0..vm-1), -1 for all components
         *  @return status, EC_Normal if successful, an error code otherwise
         */
        OFCondition getIdentifierTypeCode(OFString &value, const signed long pos = 0) const;
      ...
      // --- get DICOM sequence attributes ---
        ...
        /** get AssigningAgencyOrDepartmentCodeSequence (0040,003a)
         ...
         */
        const DRTAssigningAgencyOrDepartmentCodeSequence &getAssigningAgencyOrDepartmentCodeSequence() const
            { return AssigningAgencyOrDepartmentCodeSequence; }

        /** get AssigningFacilitySequence (0040,0036)
         *  @return reference to sequence element
         */
        DRTAssigningFacilitySequence &getAssigningFacilitySequence()
            { return AssigningFacilitySequence; }

        /** get AssigningFacilitySequence (0040,0036)
         *  @return const reference to sequence element
         */
        const DRTAssigningFacilitySequence &getAssigningFacilitySequence() const
            { return AssigningFacilitySequence; }

        /** get AssigningJurisdictionCodeSequence (0040,0039)
         *  @return reference to sequence element
         */
        DRTAssigningJurisdictionCodeSequence &getAssigningJurisdictionCodeSequence()
            { return AssigningJurisdictionCodeSequence; }

        /** get AssigningJurisdictionCodeSequence (0040,0039)
         *  @return const reference to sequence element
         */
        const DRTAssigningJurisdictionCodeSequence &getAssigningJurisdictionCodeSequence() const
            { return AssigningJurisdictionCodeSequence; }

      // --- set DICOM attribute values ---

        /** set IdentifierTypeCode (0040,0035)
         *  @param  value  value to be set (single value only) or "" for no value
         *  @param  check  check 'value' for conformance with VR (CS) and VM (1) if enabled
         *  @return status, EC_Normal if successful, an error code otherwise
         */
        OFCondition setIdentifierTypeCode(const OFString &value, const OFBool check = OFTrue);
      ...
      private:
        ...
        /// AssigningAgencyOrDepartmentCodeSequence (0040,003a) vr=SQ, vm=1, type=3
        DRTAssigningAgencyOrDepartmentCodeSequence AssigningAgencyOrDepartmentCodeSequence;
        /// AssigningFacilitySequence (0040,0036) vr=SQ, vm=1, type=3
        DRTAssigningFacilitySequence AssigningFacilitySequence;
        /// AssigningJurisdictionCodeSequence (0040,0039) vr=SQ, vm=1, type=3
        DRTAssigningJurisdictionCodeSequence AssigningJurisdictionCodeSequence;
        /// IdentifierTypeCode (0040,0035) vr=CS, vm=1, type=3
        DcmCodeString IdentifierTypeCode;
        /// UniversalEntityID (0040,0032) vr=UT, vm=1, type=3
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTIssuerOfPatientIDQualifiersSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTIssuerOfPatientIDQualifiersSequence(const DRTIssuerOfPatientIDQualifiersSequence &copy);

    /** destructor
     */
    virtual ~DRTIssuerOfPatientIDQualifiersSequence();
