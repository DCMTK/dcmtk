 ...
 */
class DCMTK_DCMRT_EXPORT DRTReferencedSpatialRegistrationSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReferencedSpatialRegistrationSequence(const DRTReferencedSpatialRegistrationSequence &copy);
