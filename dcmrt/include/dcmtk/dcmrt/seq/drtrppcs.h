 ...
 */
class DCMTK_DCMRT_EXPORT DRTReasonForPerformedProcedureCodeSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTReasonForPerformedProcedureCodeSequence(const OFBool emptyDefaultSequence = OFFalse);

    /** copy constructor
     *  @param copy sequence object to be copied
     */
    DRTReasonForPerformedProcedureCodeSequence(const DRTReasonForPerformedProcedureCodeSequence &copy);

    /** destructor
     */
    virtual ~DRTReasonForPerformedProcedureCodeSequence();
