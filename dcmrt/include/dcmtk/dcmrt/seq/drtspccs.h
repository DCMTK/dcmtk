 ...
 */
class DCMTK_DCMRT_EXPORT DRTSegmentedPropertyCategoryCodeSequence
  : protected DRTTypes
{
  ...
  // --- constructors, destructor and operators ---
     ...
     */
    DRTSegmentedPropertyCategoryCodeSequence(const DRTSegmentedPropertyCategoryCodeSequence &copy);
