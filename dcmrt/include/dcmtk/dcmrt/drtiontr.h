...
#include "dcmtk/dcmrt/seq/drtrtrs.h"   // for ReferencedTreatmentRecordSequence
  ...
  : protected DRTTypes
{
  ...
  // --- get DICOM sequence attributes ---
     ...
     *  @return const reference to sequence element
     */
    const DRTReferencedTreatmentRecordSequence &getReferencedTreatmentRecordSequence() const
        { return ReferencedTreatmentRecordSequence; }
