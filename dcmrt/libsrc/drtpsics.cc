...
DRTPatientSizeCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTPatientSizeCodeSequence::Item::Item(const Item &copy)
...
DRTPatientSizeCodeSequence::Item::~Item()
{
}


DRTPatientSizeCodeSequence::Item &DRTPatientSizeCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTPatientSizeCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTPatientSizeCodeSequence::Item::isEmpty()
{
...
OFBool DRTPatientSizeCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTPatientSizeCodeSequence::Item::read(DcmItem &item)
{
...
OFCondition DRTPatientSizeCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTPatientSizeCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::getContextUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTPatientSizeCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTPatientSizeCodeSequence::Item::setContextUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTPatientSizeCodeSequence::DRTPatientSizeCodeSequence(const DRTPatientSizeCodeSequence &copy)
...
DRTPatientSizeCodeSequence &DRTPatientSizeCodeSequence::operator=(const DRTPatientSizeCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTPatientSizeCodeSequence::~DRTPatientSizeCodeSequence()
{
    clear();
}


void DRTPatientSizeCodeSequence::clear()
{
...
OFBool DRTPatientSizeCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTPatientSizeCodeSequence::isValid() const
{
...
OFCondition DRTPatientSizeCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTPatientSizeCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTPatientSizeCodeSequence::Item &DRTPatientSizeCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTPatientSizeCodeSequence::Item &DRTPatientSizeCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTPatientSizeCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTPatientSizeCodeSequence::read(DcmItem &dataset,
                                             const OFString &card,
                                             const OFString &type,
                                             const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_PatientSizeCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_PatientSizeCodeSequence);
...
OFCondition DRTPatientSizeCodeSequence::write(DcmItem &dataset,
                                              const OFString &card,
                                              const OFString &type,
                                              const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_PatientSizeCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
