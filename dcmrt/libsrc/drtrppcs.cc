...
DRTReasonForPerformedProcedureCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTReasonForPerformedProcedureCodeSequence::Item::Item(const Item &copy)
...
DRTReasonForPerformedProcedureCodeSequence::Item::~Item()
{
}


DRTReasonForPerformedProcedureCodeSequence::Item &DRTReasonForPerformedProcedureCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTReasonForPerformedProcedureCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTReasonForPerformedProcedureCodeSequence::Item::isEmpty()
{
...
OFBool DRTReasonForPerformedProcedureCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::read(DcmItem &item)
{
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::getContextUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::Item::setContextUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTReasonForPerformedProcedureCodeSequence::DRTReasonForPerformedProcedureCodeSequence(const DRTReasonForPerformedProcedureCodeSequence &copy)
...
DRTReasonForPerformedProcedureCodeSequence &DRTReasonForPerformedProcedureCodeSequence::operator=(const DRTReasonForPerformedProcedureCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTReasonForPerformedProcedureCodeSequence::~DRTReasonForPerformedProcedureCodeSequence()
{
    clear();
}


void DRTReasonForPerformedProcedureCodeSequence::clear()
{
...
OFBool DRTReasonForPerformedProcedureCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTReasonForPerformedProcedureCodeSequence::isValid() const
{
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTReasonForPerformedProcedureCodeSequence::Item &DRTReasonForPerformedProcedureCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTReasonForPerformedProcedureCodeSequence::Item &DRTReasonForPerformedProcedureCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::read(DcmItem &dataset,
                                                             const OFString &card,
                                                             const OFString &type,
                                                             const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_ReasonForPerformedProcedureCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_ReasonForPerformedProcedureCodeSequence);
...
OFCondition DRTReasonForPerformedProcedureCodeSequence::write(DcmItem &dataset,
                                                              const OFString &card,
                                                              const OFString &type,
                                                              const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_ReasonForPerformedProcedureCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
