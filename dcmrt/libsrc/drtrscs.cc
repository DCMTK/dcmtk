...
DRTRequestingServiceCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTRequestingServiceCodeSequence::Item::Item(const Item &copy)
...
DRTRequestingServiceCodeSequence::Item::~Item()
{
}


DRTRequestingServiceCodeSequence::Item &DRTRequestingServiceCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTRequestingServiceCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTRequestingServiceCodeSequence::Item::isEmpty()
{
...
OFBool DRTRequestingServiceCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTRequestingServiceCodeSequence::Item::read(DcmItem &item)
{
...
OFCondition DRTRequestingServiceCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTRequestingServiceCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::getContextUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTRequestingServiceCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTRequestingServiceCodeSequence::Item::setContextUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTRequestingServiceCodeSequence::DRTRequestingServiceCodeSequence(const DRTRequestingServiceCodeSequence &copy)
...
DRTRequestingServiceCodeSequence &DRTRequestingServiceCodeSequence::operator=(const DRTRequestingServiceCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTRequestingServiceCodeSequence::~DRTRequestingServiceCodeSequence()
{
    clear();
}


void DRTRequestingServiceCodeSequence::clear()
{
...
OFBool DRTRequestingServiceCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTRequestingServiceCodeSequence::isValid() const
{
...
OFCondition DRTRequestingServiceCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTRequestingServiceCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTRequestingServiceCodeSequence::Item &DRTRequestingServiceCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTRequestingServiceCodeSequence::Item &DRTRequestingServiceCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTRequestingServiceCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTRequestingServiceCodeSequence::read(DcmItem &dataset,
                                                   const OFString &card,
                                                   const OFString &type,
                                                   const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_RequestingServiceCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_RequestingServiceCodeSequence);
...
OFCondition DRTRequestingServiceCodeSequence::write(DcmItem &dataset,
                                                    const OFString &card,
                                                    const OFString &type,
                                                    const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_RequestingServiceCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
