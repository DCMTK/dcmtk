...
DRTAssigningJurisdictionCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTAssigningJurisdictionCodeSequence::Item::Item(const Item &copy)
...
DRTAssigningJurisdictionCodeSequence::Item::~Item()
{
}


DRTAssigningJurisdictionCodeSequence::Item &DRTAssigningJurisdictionCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTAssigningJurisdictionCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTAssigningJurisdictionCodeSequence::Item::isEmpty()
{
...
OFBool DRTAssigningJurisdictionCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTAssigningJurisdictionCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "AssigningJurisdictionCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "AssigningJurisdictionCodeSequence");
    }
    return result;
}


OFCondition DRTAssigningJurisdictionCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::getContextUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::Item::setContextUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTAssigningJurisdictionCodeSequence::DRTAssigningJurisdictionCodeSequence(const DRTAssigningJurisdictionCodeSequence &copy)
...
DRTAssigningJurisdictionCodeSequence &DRTAssigningJurisdictionCodeSequence::operator=(const DRTAssigningJurisdictionCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTAssigningJurisdictionCodeSequence::~DRTAssigningJurisdictionCodeSequence()
{
    clear();
}


void DRTAssigningJurisdictionCodeSequence::clear()
{
...
OFBool DRTAssigningJurisdictionCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTAssigningJurisdictionCodeSequence::isValid() const
{
...
OFCondition DRTAssigningJurisdictionCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTAssigningJurisdictionCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTAssigningJurisdictionCodeSequence::Item &DRTAssigningJurisdictionCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTAssigningJurisdictionCodeSequence::Item &DRTAssigningJurisdictionCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTAssigningJurisdictionCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTAssigningJurisdictionCodeSequence::read(DcmItem &dataset,
                                                       const OFString &card,
                                                       const OFString &type,
                                                       const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_AssigningJurisdictionCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_AssigningJurisdictionCodeSequence);
...
OFCondition DRTAssigningJurisdictionCodeSequence::write(DcmItem &dataset,
                                                        const OFString &card,
                                                        const OFString &type,
                                                        const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_AssigningJurisdictionCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
