...
DRTAssigningAgencyOrDepartmentCodeSequence::Item::Item(const OFBool emptyDefaultItem)
...
DRTAssigningAgencyOrDepartmentCodeSequence::Item::Item(const Item &copy)
...
DRTAssigningAgencyOrDepartmentCodeSequence::Item::~Item()
{
}


DRTAssigningAgencyOrDepartmentCodeSequence::Item &DRTAssigningAgencyOrDepartmentCodeSequence::Item::operator=(const Item &copy)
{
    if (this != &copy)
    {
        EmptyDefaultItem = copy.EmptyDefaultItem;
...
void DRTAssigningAgencyOrDepartmentCodeSequence::Item::clear()
{
    if (!EmptyDefaultItem)
    {
...
OFBool DRTAssigningAgencyOrDepartmentCodeSequence::Item::isEmpty()
{
...
OFBool DRTAssigningAgencyOrDepartmentCodeSequence::Item::isValid() const
{
    return !EmptyDefaultItem;
}


OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::read(DcmItem &item)
{
    ...
    if (!EmptyDefaultItem)
    {
        ...
        getAndCheckElementFromDataset(item, ContextGroupExtensionCreatorUID, "1", "1C", "AssigningAgencyOrDepartmentCodeSequence");
        result = EC_Normal;
    }
    return result;
}
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::write(DcmItem &item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
        ...
        addElementToDataset(result, item, new DcmUniqueIdentifier(ContextGroupExtensionCreatorUID), "1", "1C", "AssigningAgencyOrDepartmentCodeSequence");
    }
    return result;
}


OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getCodeMeaning(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getCodeValue(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getCodingSchemeDesignator(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getCodingSchemeVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getContextGroupExtensionCreatorUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getContextGroupExtensionFlag(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getContextGroupLocalVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getContextGroupVersion(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getContextIdentifier(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::getContextUID(OFString &value, const signed long pos) const
{
    if (EmptyDefaultItem)
        return EC_IllegalCall;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setCodeValue(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setCodingSchemeDesignator(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setCodingSchemeVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setContextGroupExtensionCreatorUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setContextGroupExtensionFlag(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setContextGroupLocalVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setContextGroupVersion(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setContextIdentifier(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::Item::setContextUID(const OFString &value, const OFBool check)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultItem)
    {
...
DRTAssigningAgencyOrDepartmentCodeSequence::DRTAssigningAgencyOrDepartmentCodeSequence(const DRTAssigningAgencyOrDepartmentCodeSequence &copy)
...
DRTAssigningAgencyOrDepartmentCodeSequence &DRTAssigningAgencyOrDepartmentCodeSequence::operator=(const DRTAssigningAgencyOrDepartmentCodeSequence &copy)
{
    if (this != &copy)
    {
        clear();
...
DRTAssigningAgencyOrDepartmentCodeSequence::~DRTAssigningAgencyOrDepartmentCodeSequence()
{
    clear();
}


void DRTAssigningAgencyOrDepartmentCodeSequence::clear()
{
...
OFBool DRTAssigningAgencyOrDepartmentCodeSequence::isEmpty()
{
    return SequenceOfItems.empty();
}


OFBool DRTAssigningAgencyOrDepartmentCodeSequence::isValid() const
{
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::gotoFirstItem()
{
    OFCondition result = EC_IllegalCall;
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::getCurrentItem(Item *&item) const
{
    OFCondition result = EC_IllegalCall;
    if (CurrentItem != SequenceOfItems.end())
    {
...
DRTAssigningAgencyOrDepartmentCodeSequence::Item &DRTAssigningAgencyOrDepartmentCodeSequence::getCurrentItem()
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
const DRTAssigningAgencyOrDepartmentCodeSequence::Item &DRTAssigningAgencyOrDepartmentCodeSequence::getCurrentItem() const
{
    if (CurrentItem != SequenceOfItems.end())
        return **CurrentItem;
    else
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::addItem(Item *&item)
{
    OFCondition result = EC_IllegalCall;
    if (!EmptyDefaultSequence)
    {
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::read(DcmItem &dataset,
                                                             const OFString &card,
                                                             const OFString &type,
                                                             const char *moduleName)
{
    ...
    if (!EmptyDefaultSequence)
    {
        ...
        result = dataset.findAndGetSequence(DCM_AssigningAgencyOrDepartmentCodeSequence, sequence);
        if (sequence != NULL)
        {
            ...
            DcmSequenceOfItems element(DCM_AssigningAgencyOrDepartmentCodeSequence);
...
OFCondition DRTAssigningAgencyOrDepartmentCodeSequence::write(DcmItem &dataset,
                                                              const OFString &card,
                                                              const OFString &type,
                                                              const char *moduleName)
{
    ...
    {
        result = EC_MemoryExhausted;
        DcmSequenceOfItems *sequence = new DcmSequenceOfItems(DCM_AssigningAgencyOrDepartmentCodeSequence);
        if (sequence != NULL)
        {
            result = EC_Normal;
