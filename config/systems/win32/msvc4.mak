...
CLEAN : 
	...
	-@erase "$(INTDIR)\dcvrut.obj"
	-@erase "$(INTDIR)\dcvrvs.obj"
...
SOURCE=.\dcmdata\libsrc\dcvrvs.cxx
...
"$(INTDIR)\dcvrvs.obj" : $(SOURCE) $(DEP_CPP_DCVRV) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\dcvrut.obj" : $(SOURCE) $(DEP_CPP_DCVRUT) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
