...
#define jpeg_source_mgr                dcmtk_jpeg8_source_mgr
#define jpeg_memory_mgr                dcmtk_jpeg8_memory_mgr
#define jpeg_common_struct             dcmtk_jpeg8_common_struct
#define jpeg_error_mgr                 dcmtk_jpeg8_error_mgr
#define jpeg_compress_struct           dcmtk_jpeg8_compress_struct
#define j_compress_ptr                 dcmtk_j8_compress_ptr
#define jpeg_destination_mgr           dcmtk_jpeg8_destination_mgr
#endif
