...
#  /LIBPATH:../../dcmnet\$(INTDIR)  /LIBPATH:../../dcmnet\  /LIBPATH:../../ofstd\$(INTDIR)  /LIBPATH:../../ofstd\  /LIBPATH:../../dcmdata\$(INTDIR)  /LIBPATH:../../dcmdata\  /LIBPATH:../../dcmtls\$(INTDIR)  /LIBPATH:../../dcmtls\  /LIBPATH:../../../zlib-1.1.4\lib\$(INTDIR)  /LIBPATH:../../../zlib-1.1.4\lib\  /LIBPATH:../../ofstd\libsrc\$(INTDIR)  /LIBPATH:../../ofstd\libsrc\  /LIBPATH:../../dcmdata\libsrc\$(INTDIR)  /LIBPATH:../../dcmdata\libsrc\  /LIBPATH:../../dcmnet\libsrc\$(INTDIR)  /LIBPATH:../../dcmnet\libsrc\  netapi32.lib wsock32.lib ofstd.lib dcmdata.lib dcmnet.lib /INCREMENTAL:NO  == libraries linked in 
...
# ADD CPP  /I "../../config\include" /I "../../dcmnet\include" /I "../../ofstd\include" /I "../../dcmdata\include" /I "../../../zlib-1.1.4\include" /I "../../dcmtls\include"   -D_REENTRANT -DWITH_LIBPNG -DWITH_LIBTIFF -DWITH_ZLIB /D "movescu_EXPORTS"
