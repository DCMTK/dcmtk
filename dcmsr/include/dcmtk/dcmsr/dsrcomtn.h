...
/** @file dsrcomtn.h
 *  @brief definitions for class DSRCompositeTreeNode
 */
...
/** equality operator.
 *  Internally, the DSRCompositeTreeNode::isEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
 *  @return OFTrue if 'lhs' and 'rhs' are equal, OFFalse otherwise
 */
DCMTK_DCMSR_EXPORT OFBool operator==(const DSRCompositeTreeNode &lhs,
                                     const DSRCompositeTreeNode &rhs);

/** inequality operator.
 *  Internally, the DSRCompositeTreeNode::isNotEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
