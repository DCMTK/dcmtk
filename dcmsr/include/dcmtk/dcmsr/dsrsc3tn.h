...
/** @file dsrsc3tn.h
 *  @brief definitions for class DSRSCoord3DTreeNode
 */
...
/** equality operator.
 *  Internally, the DSRSCoord3DTreeNode::isEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
 *  @return OFTrue if 'lhs' and 'rhs' are equal, OFFalse otherwise
 */
DCMTK_DCMSR_EXPORT OFBool operator==(const DSRSCoord3DTreeNode &lhs,
                                     const DSRSCoord3DTreeNode &rhs);

/** inequality operator.
 *  Internally, the DSRSCoord3DTreeNode::isNotEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
