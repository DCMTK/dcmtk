...
/** @file dsrdtitn.h
 *  @brief definitions for class DSRDateTimeTreeNode
 */
...
/** equality operator.
 *  Internally, the DSRDateTimeTreeNode::isEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
 *  @return OFTrue if 'lhs' and 'rhs' are equal, OFFalse otherwise
 */
DCMTK_DCMSR_EXPORT OFBool operator==(const DSRDateTimeTreeNode &lhs,
                                     const DSRDateTimeTreeNode &rhs);

/** inequality operator.
 *  Internally, the DSRDateTimeTreeNode::isNotEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
