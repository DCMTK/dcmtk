...
/** @file dsrwavtn.h
 *  @brief definitions for class DSRWaveformTreeNode
 */
...
/** equality operator.
 *  Internally, the DSRWaveformTreeNode::isEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
 *  @return OFTrue if 'lhs' and 'rhs' are equal, OFFalse otherwise
 */
DCMTK_DCMSR_EXPORT OFBool operator==(const DSRWaveformTreeNode &lhs,
                                     const DSRWaveformTreeNode &rhs);

/** inequality operator.
 *  Internally, the DSRWaveformTreeNode::isNotEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
