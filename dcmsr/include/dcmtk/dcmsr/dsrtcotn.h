...
/** @file dsrtcotn.h
 *  @brief definitions for class DSRTCoordTreeNode
 */
...
/** equality operator.
 *  Internally, the DSRTCoordTreeNode::isEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
 *  @return OFTrue if 'lhs' and 'rhs' are equal, OFFalse otherwise
 */
DCMTK_DCMSR_EXPORT OFBool operator==(const DSRTCoordTreeNode &lhs,
                                     const DSRTCoordTreeNode &rhs);

/** inequality operator.
 *  Internally, the DSRTCoordTreeNode::isNotEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
