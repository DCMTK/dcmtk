...
/** @file dsrtimtn.h
 *  @brief definitions for class DSRTimeTreeNode
 */
...
/** equality operator.
 *  Internally, the DSRTimeTreeNode::isEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
 *  @return OFTrue if 'lhs' and 'rhs' are equal, OFFalse otherwise
 */
DCMTK_DCMSR_EXPORT OFBool operator==(const DSRTimeTreeNode &lhs,
                                     const DSRTimeTreeNode &rhs);

/** inequality operator.
 *  Internally, the DSRTimeTreeNode::isNotEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
