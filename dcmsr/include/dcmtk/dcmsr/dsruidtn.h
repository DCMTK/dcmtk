...
/** @file dsruidtn.h
 *  @brief definitions for class DSRUIDRefTreeNode
 */
...
/** equality operator.
 *  Internally, the DSRUIDRefTreeNode::isEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
 *  @return OFTrue if 'lhs' and 'rhs' are equal, OFFalse otherwise
 */
DCMTK_DCMSR_EXPORT OFBool operator==(const DSRUIDRefTreeNode &lhs,
                                     const DSRUIDRefTreeNode &rhs);

/** inequality operator.
 *  Internally, the DSRUIDRefTreeNode::isNotEqual() method is used.
 *  @param  lhs  left-hand side
 *  @param  rhs  right-hand side
