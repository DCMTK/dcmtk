...
#ifndef _DcmDictEntryPtrdefs_h
#define _DcmDictEntryPtrdefs_h 1

#include "dcdicent.h"
typedef DcmDictEntry* DcmDictEntryPtr;

// equality operator
#ifndef DcmDictEntryPtrEQ
#define DcmDictEntryPtrEQ(a, b)  ((*a) == (*b))
#endif

// less-than-or-equal
#ifndef DcmDictEntryPtrLE
#define DcmDictEntryPtrLE(a, b)  ((*a) <= (*b))
#endif
...
// hash function
#ifndef DcmDictEntryPtrHASH
extern unsigned int hash(DcmDictEntryPtr );
#define DcmDictEntryPtrHASH(x)  hash(x)
#endif
