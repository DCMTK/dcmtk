...
#define DCM_TypeOfData                           DcmTagKey(0x5000, 0x0020)
#define DCM_CurveDescription                     DcmTagKey(0x5000, 0x0022)
#define DCM_AxisUnits                            DcmTagKey(0x5000, 0x0030)
#define DCM_AxisLabels                           DcmTagKey(0x5000, 0x0040)
#define DCM_DataValueRepresentation              DcmTagKey(0x5000, 0x0103)
#define DCM_MinimumCoordinateValue               DcmTagKey(0x5000, 0x0104)
#define DCM_MaximumCoordinateValue               DcmTagKey(0x5000, 0x0105)
#define DCM_CurveRange                           DcmTagKey(0x5000, 0x0106)
#define DCM_CurveDataDescriptor                  DcmTagKey(0x5000, 0x0110)
#define DCM_CoordinateStartValue                 DcmTagKey(0x5000, 0x0112)
#define DCM_CoordinateStepValue                  DcmTagKey(0x5000, 0x0114)
#define DCM_AudioType                            DcmTagKey(0x5000, 0x2000)
#define DCM_AudioSampleFormat                    DcmTagKey(0x5000, 0x2002)
#define DCM_NumberOfChannels                     DcmTagKey(0x5000, 0x2004)
#define DCM_NumberOfSamples                      DcmTagKey(0x5000, 0x2006)
#define DCM_SampleRate                           DcmTagKey(0x5000, 0x2008)
#define DCM_TotalTime                            DcmTagKey(0x5000, 0x200a)
#define DCM_AudioSampleData                      DcmTagKey(0x5000, 0x200c)
#define DCM_AudioComments                        DcmTagKey(0x5000, 0x200e)
#define DCM_CurveData                            DcmTagKey(0x5000, 0x3000)
#define DCM_OverlayGroupLength                   DcmTagKey(0x6000, 0x0000)
#define DCM_OverlayRows                          DcmTagKey(0x6000, 0x0010)
#define DCM_OverlayColumns                       DcmTagKey(0x6000, 0x0011)
#define DCM_OverlayNumberOfFrames                DcmTagKey(0x6000, 0x0015)
#define DCM_OverlayType                          DcmTagKey(0x6000, 0x0040)
#define DCM_OverlayOrigin                        DcmTagKey(0x6000, 0x0050)
#define DCM_OverlayCompressionCode               DcmTagKey(0x6000, 0x0060)
#define DCM_OverlayCompressionOriginator         DcmTagKey(0x6000, 0x0061)
#define DCM_OverlayCompressionLabel              DcmTagKey(0x6000, 0x0062)
#define DCM_OverlayCompressionDescription        DcmTagKey(0x6000, 0x0063)
#define DCM_OverlayCompressionStepPointers       DcmTagKey(0x6000, 0x0066)
#define DCM_OverlayRepeatInterval                DcmTagKey(0x6000, 0x0068)
#define DCM_OverlayBitsGrouped                   DcmTagKey(0x6000, 0x0069)
#define DCM_OverlayBitsAllocated                 DcmTagKey(0x6000, 0x0100)
#define DCM_OverlayBitPosition                   DcmTagKey(0x6000, 0x0102)
#define DCM_OverlayFormat                        DcmTagKey(0x6000, 0x0110)
#define DCM_OverlayLocation                      DcmTagKey(0x6000, 0x0200)
#define DCM_OverlayCodeLabel                     DcmTagKey(0x6000, 0x0800)
#define DCM_OverlayNumberOfTables                DcmTagKey(0x6000, 0x0802)
#define DCM_OverlayCodeTableLocation             DcmTagKey(0x6000, 0x0803)
#define DCM_OverlayBitsForCodeWord               DcmTagKey(0x6000, 0x0804)
#define DCM_OverlayDescriptorGray                DcmTagKey(0x6000, 0x1100)
#define DCM_OverlayDescriptorRed                 DcmTagKey(0x6000, 0x1101)
#define DCM_OverlayDescriptorGreen               DcmTagKey(0x6000, 0x1102)
#define DCM_OverlayDescriptorBlue                DcmTagKey(0x6000, 0x1103)
#define DCM_OverlayGray                          DcmTagKey(0x6000, 0x1200)
#define DCM_OverlayRed                           DcmTagKey(0x6000, 0x1201)
#define DCM_OverlayGreen                         DcmTagKey(0x6000, 0x1202)
#define DCM_OverlayBlue                          DcmTagKey(0x6000, 0x1203)
#define DCM_ROIArea                              DcmTagKey(0x6000, 0x1301)
#define DCM_ROIMean                              DcmTagKey(0x6000, 0x1302)
#define DCM_ROIStandardDeviation                 DcmTagKey(0x6000, 0x1303)
#define DCM_OverlayData                          DcmTagKey(0x6000, 0x3000)
#define DCM_OverlayComments                      DcmTagKey(0x6000, 0x4000)
#define DCM_VariablePixelDataGroupLength         DcmTagKey(0x7f00, 0x0000)
#define DCM_VariablePixelData                    DcmTagKey(0x7f00, 0x0010)
#define DCM_VariableNextDataGroup                DcmTagKey(0x7f00, 0x0011)
#define DCM_VariableCoefficientsSDVN             DcmTagKey(0x7f00, 0x0020)
#define DCM_VariableCoefficientsSDHN             DcmTagKey(0x7f00, 0x0030)
#define DCM_VariableCoefficientsSDDN             DcmTagKey(0x7f00, 0x0040)
