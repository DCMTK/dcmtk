 ...
 *  Update Date:      $Date: 2002-04-25 09:57:46 $
...
public:
    ...
    virtual OFCondition putSint16Array(const Sint16 * sintVal,
				       const unsigned long numSints); 

    virtual OFCondition putSint16(const Sint16 sintVal,	 // one Sint16
				  const unsigned long numSint = 0);     
                                                         // at any position

    virtual OFCondition putString(const char * value);  // Sint16 as Strings
