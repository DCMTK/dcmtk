...
public:
     ...
     *  with a given object of the same type, i.e. the items in the sequences
     *  and the elements they contain are compared by value! This may be an
     *  expensive operation.  The tag of the element is also considered as
     *  the first component that is compared.
     *  @param  rhs the right hand side of the comparison
     *  @return 0 if the object values are equal.
     *          -1 if either the value of the  first component that does not match
     *          is lower in the rhs object, or all compared components match
     *          but the rhs component is shorter. Also returned if rhs cannot
     *          be casted to DcmSequenceOfItems.
     *          1 if either the value of the first component that does not match
