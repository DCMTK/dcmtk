...
- test cases for JIS X 0212 Kanji
...
void convert_utf8_to_euc_alternative(const char *charset, unsigned char *reference, size_t refsize, unsigned char *src, size_t srcsize)
{
  iconv_t invalid_id = OFreinterpret_cast(iconv_t, -1);
  iconv_t id;
...
OFTEST(oficonv_utf8_to_gbk)
{
  ...
  convert_utf8_to_euc_alternative("GBK", gbk_row_0xa8_alternative, sizeof(gbk_row_0xa8_alternative), gbk_row_0xa8_converted_to_utf8, sizeof(gbk_row_0xa8_converted_to_utf8));
  ...
  convert_utf8_to_euc_alternative("GBK", gbk_row_0xa9_alternative, sizeof(gbk_row_0xa9_alternative), gbk_row_0xa9_converted_to_utf8, sizeof(gbk_row_0xa9_converted_to_utf8));
  ...
  convert_utf8_to_euc_alternative("GBK", gbk_row_0xfe_alternative, sizeof(gbk_row_0xfe_alternative), gbk_row_0xfe_converted_to_utf8, sizeof(gbk_row_0xfe_converted_to_utf8));
}
