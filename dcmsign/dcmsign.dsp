...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "..\..\openssl-0.9.6h\include" /I "include" /I "..\config\include" /I "..\ofstd\include" /I "..\dcmdata\include" /I "..\..\zlib-1.1.4\include" /D "_WINDOWS" /D "WITH_OPENSSL" /D "WIN32" /D "NDEBUG" /D "_REENTRANT" /YX /FD /c
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LIB32=link.exe -lib
