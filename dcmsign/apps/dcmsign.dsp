...
# dcmsign  == name of output library
#  /LIBPATH:../../dcmsign\$(INTDIR)  /LIBPATH:../../dcmsign\  /LIBPATH:../../ofstd\$(INTDIR)  /LIBPATH:../../ofstd\  /LIBPATH:../../dcmdata\$(INTDIR)  /LIBPATH:../../dcmdata\  /LIBPATH:../../../zlib-1.2.1\lib\$(INTDIR)  /LIBPATH:../../../zlib-1.2.1\lib\  /LIBPATH:../../ofstd\libsrc\$(INTDIR)  /LIBPATH:../../ofstd\libsrc\  /LIBPATH:../../dcmdata\libsrc\$(INTDIR)  /LIBPATH:../../dcmdata\libsrc\  /LIBPATH:../../dcmsign\libsrc\$(INTDIR)  /LIBPATH:../../dcmsign\libsrc\  netapi32.lib wsock32.lib ofstd.lib dcmdata.lib dcmdsig.lib /INCREMENTAL:NO  == libraries linked in 
...
!MESSAGE 
!MESSAGE "dcmsign - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "dcmsign - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "dcmsign - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE "dcmsign - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP  /I "../../config\include" /I "../../dcmsign\include" /I "../../ofstd\include" /I "../../dcmdata\include" /I "../../../zlib-1.2.1\include"   -D_REENTRANT -DWITH_LIBPNG -DWITH_LIBTIFF -DWITH_ZLIB /D "dcmsign_EXPORTS"
# ADD CPP  /D "_MBCS"
...
!ELSEIF  "$(CFG)" == "dcmsign - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
# PROP Target_Dir ""
# ADD BASE CPP /nologo  /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS"  /FD /c
# ADD CPP /nologo  /D "WIN32"  /I "../../config\include" /I "../../dcmsign\include" /I "../../ofstd\include" /I "../../dcmdata\include" /I "../../../zlib-1.2.1\include"   -D_REENTRANT -DWITH_LIBPNG -DWITH_LIBTIFF -DWITH_ZLIB /D "NDEBUG" /D "_CONSOLE" /D "_MBCS"  /FD /c
# ADD CPP  /I "../../config\include" /I "../../dcmsign\include" /I "../../ofstd\include" /I "../../dcmdata\include" /I "../../../zlib-1.2.1\include"   -D_REENTRANT -DWITH_LIBPNG -DWITH_LIBTIFF -DWITH_ZLIB /D "dcmsign_EXPORTS"
# ADD CPP  /D "_MBCS"
...
!ELSEIF  "$(CFG)" == "dcmsign - Win32 RelWithDebInfo"
...
# Name "dcmsign - Win32 MinSizeRel"
# Name "dcmsign - Win32 RelWithDebInfo"
# Begin Group "Source Files"
# PROP Default_Filter ""
# Begin Source File

SOURCE=../../dcmsign\apps\dcmsign.cxx
