...
#ifndef HAVE_OPENSSL_X509_GET0_NOTBEFORE
#define X509_get0_notBefore(x) X509_get_notBefore(x)
#endif

#ifndef HAVE_OPENSSL_X509_GET0_NOTAFTER
#define X509_get0_notAfter(x) X509_get_notAfter(x)
#endif

#ifndef HAVE_OPENSSL_TS_STATUS_INFO_GET0_STATUS
#define TS_STATUS_INFO_get0_status(x) (x)->status
#endif

#ifndef HAVE_OPENSSL_TS_STATUS_INFO_GET0_TEXT
#define TS_STATUS_INFO_get0_text(x) (x)->text
#endif

#ifndef HAVE_OPENSSL_TS_STATUS_INFO_GET0_FAILURE_INFO
#define TS_STATUS_INFO_get0_failure_info(x) (x)->failure_info
#endif

#ifndef HAVE_OPENSSL_TS_VERIFY_CTS_SET_CERTS
#define TS_VERIFY_CTS_set_certs(x,y) ((x)->certs = (y))
#endif

#ifndef HAVE_OPENSSL_TS_VERIFY_CTX_SET_DATA
#define TS_VERIFY_CTX_set_data(x,y) ((x)->data = (y))
#endif

#ifndef HAVE_OPENSSL_TS_VERIFY_CTX_SET_FLAGS
#define TS_VERIFY_CTX_set_flags(x,y) ((x)->flags = (y))
#endif

#ifndef HAVE_OPENSSL_TS_VERIFY_CTX_SET_STORE
#define TS_VERIFY_CTX_set_store(x,y) ((x)->store = (y))
#endif

#ifndef HAVE_OPENSSL_ASN1_STRING_GET0_DATA
