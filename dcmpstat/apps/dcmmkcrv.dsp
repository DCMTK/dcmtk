...
#  /LIBPATH:../../dcmpstat\$(INTDIR)  /LIBPATH:../../dcmpstat\  /LIBPATH:../../ofstd\$(INTDIR)  /LIBPATH:../../ofstd\  /LIBPATH:../../dcmdata\$(INTDIR)  /LIBPATH:../../dcmdata\  /LIBPATH:../../dcmtls\$(INTDIR)  /LIBPATH:../../dcmtls\  /LIBPATH:../../dcmnet\$(INTDIR)  /LIBPATH:../../dcmnet\  /LIBPATH:../../imagectn\$(INTDIR)  /LIBPATH:../../imagectn\  /LIBPATH:../../dcmimgle\$(INTDIR)  /LIBPATH:../../dcmimgle\  /LIBPATH:../../dcmsr\$(INTDIR)  /LIBPATH:../../dcmsr\  /LIBPATH:../../dcmsign\$(INTDIR)  /LIBPATH:../../dcmsign\  /LIBPATH:../../../zlib-1.1.4\lib\$(INTDIR)  /LIBPATH:../../../zlib-1.1.4\lib\  /LIBPATH:../../ofstd\libsrc\$(INTDIR)  /LIBPATH:../../ofstd\libsrc\  /LIBPATH:../../dcmdata\libsrc\$(INTDIR)  /LIBPATH:../../dcmdata\libsrc\  /LIBPATH:../../dcmnet\libsrc\$(INTDIR)  /LIBPATH:../../dcmnet\libsrc\  /LIBPATH:../../imagectn\libsrc\$(INTDIR)  /LIBPATH:../../imagectn\libsrc\  /LIBPATH:../../dcmimgle\libsrc\$(INTDIR)  /LIBPATH:../../dcmimgle\libsrc\  /LIBPATH:../../dcmpstat\libsrc\$(INTDIR)  /LIBPATH:../../dcmpstat\libsrc\  netapi32.lib wsock32.lib ofstd.lib dcmdata.lib dcmnet.lib imagedb.lib dcmimgle.lib dcmpstat.lib /INCREMENTAL:NO  == libraries linked in 
...
# ADD CPP  /I "../../config\include" /I "../../dcmpstat\include" /I "../../ofstd\include" /I "../../dcmdata\include" /I "../../dcmnet\include" /I "../../dcmimgle\include" /I "../../imagectn\include" /I "../../dcmsr\include" /I "../../dcmsign\include" /I "../../../zlib-1.1.4\include" /I "../../dcmtls\include"   -D_REENTRANT -DWITH_LIBPNG -DWITH_LIBTIFF -DWITH_ZLIB /D "dcmmkcrv_EXPORTS"
# ADD CPP  
