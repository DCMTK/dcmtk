...
# dcmpschk  == name of output library
#  /LIBPATH:../../dcmpstat\$(INTDIR)  /LIBPATH:../../dcmpstat\  /LIBPATH:../../ofstd\$(INTDIR)  /LIBPATH:../../ofstd\  /LIBPATH:../../dcmdata\$(INTDIR)  /LIBPATH:../../dcmdata\  /LIBPATH:../../dcmtls\$(INTDIR)  /LIBPATH:../../dcmtls\  /LIBPATH:../../dcmnet\$(INTDIR)  /LIBPATH:../../dcmnet\  /LIBPATH:../../imagectn\$(INTDIR)  /LIBPATH:../../imagectn\  /LIBPATH:../../dcmimgle\$(INTDIR)  /LIBPATH:../../dcmimgle\  /LIBPATH:../../dcmsr\$(INTDIR)  /LIBPATH:../../dcmsr\  /LIBPATH:../../dcmsign\$(INTDIR)  /LIBPATH:../../dcmsign\  /LIBPATH:../../../zlib-1.1.4\lib\$(INTDIR)  /LIBPATH:../../../zlib-1.1.4\lib\  /LIBPATH:../../ofstd\libsrc\$(INTDIR)  /LIBPATH:../../ofstd\libsrc\  /LIBPATH:../../dcmdata\libsrc\$(INTDIR)  /LIBPATH:../../dcmdata\libsrc\  /LIBPATH:../../dcmimgle\libsrc\$(INTDIR)  /LIBPATH:../../dcmimgle\libsrc\  /LIBPATH:../../dcmpstat\libsrc\$(INTDIR)  /LIBPATH:../../dcmpstat\libsrc\  /LIBPATH:../../dcmsr\libsrc\$(INTDIR)  /LIBPATH:../../dcmsr\libsrc\  netapi32.lib wsock32.lib ofstd.lib dcmdata.lib dcmimgle.lib dcmpstat.lib dcmsr.lib /INCREMENTAL:NO  == libraries linked in 
# TARGTYPE "Win32 (x86) Application" 0x0103

CFG=dcmpschk - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "dcmpschk.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "dcmpschk.mak" CFG="dcmpschk - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "dcmpschk - Win32 MinSizeRel" (based on "Win32 (x86) Application")
!MESSAGE "dcmpschk - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "dcmpschk - Win32 RelWithDebInfo" (based on "Win32 (x86) Application")
!MESSAGE "dcmpschk - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
# ADD CPP  /I "../../config\include" /I "../../dcmpstat\include" /I "../../ofstd\include" /I "../../dcmdata\include" /I "../../dcmnet\include" /I "../../dcmimgle\include" /I "../../imagectn\include" /I "../../dcmsr\include" /I "../../dcmsign\include" /I "../../../zlib-1.1.4\include" /I "../../dcmtls\include"   -D_REENTRANT -DWITH_LIBPNG -DWITH_LIBTIFF -DWITH_ZLIB /D "dcmpschk_EXPORTS"
...
!ELSEIF  "$(CFG)" == "dcmpschk - Win32 Debug"
...
!ELSEIF  "$(CFG)" == "dcmpschk - Win32 MinSizeRel"
# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
...
!ELSEIF  "$(CFG)" == "dcmpschk - Win32 RelWithDebInfo"
...
# Name "dcmpschk - Win32 Release"
# Name "dcmpschk - Win32 Debug"
# Name "dcmpschk - Win32 MinSizeRel"
# Name "dcmpschk - Win32 RelWithDebInfo"
# Begin Group "Source Files"
# PROP Default_Filter ""
# Begin Source File

SOURCE=../../dcmpstat\apps\dcmpschk.cxx

# End Source File
# Begin Source File

SOURCE=../../dcmpstat\apps\vrscan.cxx
