...
# Defined with DCMTK_ prefix to avoid overriding the global command name.
if(COMMAND check_cxx_symbol_exists)
  macro(DCMTK_CHECK_CXX_SYMBOL_EXISTS SYMBOL FILES VAR)
    check_cxx_symbol_exists("${SYMBOL}" "${FILES}" "${VAR}")
  endmacro()
else()
  # Fallback for CMake versions that predate CheckCXXSymbolExists
  function(DCMTK_CHECK_CXX_SYMBOL_EXISTS SYMBOL FILES VAR)
    set(CODE)
    foreach(FILE ${FILES})
...
foreach(FUNC "__FUNCTION__" "__PRETTY_FUNCTION__" "__func__")
  ...
  DCMTK_CHECK_CXX_SYMBOL_EXISTS("${FUNC}" "" "HAVE_${FUNC}_CXX_MACRO")
...
if(NOT APPLE)
  ...
  # On Windows check_function_exists fails due to symbol name mangling; use
  # check_symbol_exists instead. Defined with DCMTK_ prefix to avoid
  # overriding the global CHECK_FUNCTION_EXISTS command.
  if(WIN32)
    macro(DCMTK_CHECK_FUNCTION_EXISTS FUNCTION VAR)
  ...
  DCMTK_CHECK_FUNCTION_EXISTS(_findfirst HAVE__FINDFIRST)
  DCMTK_CHECK_FUNCTION_EXISTS(_set_output_format HAVE__SET_OUTPUT_FORMAT)
  DCMTK_CHECK_FUNCTION_EXISTS(atoll HAVE_ATOLL)
  DCMTK_CHECK_FUNCTION_EXISTS(cuserid HAVE_CUSERID)
  DCMTK_CHECK_FUNCTION_EXISTS(fgetln HAVE_FGETLN)
  DCMTK_CHECK_FUNCTION_EXISTS(flock HAVE_FLOCK)
  DCMTK_CHECK_FUNCTION_EXISTS(fork HAVE_FORK)
  DCMTK_CHECK_FUNCTION_EXISTS(fseeko HAVE_FSEEKO)
  DCMTK_CHECK_FUNCTION_EXISTS(ftime HAVE_FTIME)
  DCMTK_CHECK_FUNCTION_EXISTS(geteuid HAVE_GETEUID)
  DCMTK_CHECK_FUNCTION_EXISTS(getgrnam HAVE_GETGRNAM)
  DCMTK_CHECK_FUNCTION_EXISTS(gethostbyaddr_r HAVE_GETHOSTBYADDR_R)
  DCMTK_CHECK_FUNCTION_EXISTS(gethostbyname_r HAVE_GETHOSTBYNAME_R)
  DCMTK_CHECK_FUNCTION_EXISTS(gethostid HAVE_GETHOSTID)
  DCMTK_CHECK_FUNCTION_EXISTS(getlogin HAVE_GETLOGIN)
  DCMTK_CHECK_FUNCTION_EXISTS(getlogin_r HAVE_GETLOGIN_R)
  DCMTK_CHECK_FUNCTION_EXISTS(getpwnam HAVE_GETPWNAM)
  DCMTK_CHECK_FUNCTION_EXISTS(gettimeofday HAVE_GETTIMEOFDAY)
  DCMTK_CHECK_FUNCTION_EXISTS(getuid HAVE_GETUID)
  DCMTK_CHECK_FUNCTION_EXISTS(gmtime_r HAVE_GMTIME_R)
  DCMTK_CHECK_FUNCTION_EXISTS(localtime_r HAVE_LOCALTIME_R)
  DCMTK_CHECK_FUNCTION_EXISTS(lockf HAVE_LOCKF)
  DCMTK_CHECK_FUNCTION_EXISTS(lstat HAVE_LSTAT)
  DCMTK_CHECK_FUNCTION_EXISTS(malloc_debug HAVE_MALLOC_DEBUG)
  DCMTK_CHECK_FUNCTION_EXISTS(mkstemp HAVE_MKSTEMP)
  DCMTK_CHECK_FUNCTION_EXISTS(nanosleep HAVE_NANOSLEEP)
  DCMTK_CHECK_FUNCTION_EXISTS(setuid HAVE_SETUID)
  DCMTK_CHECK_FUNCTION_EXISTS(sleep HAVE_SLEEP)
  DCMTK_CHECK_FUNCTION_EXISTS(strlcat HAVE_STRLCAT)
  DCMTK_CHECK_FUNCTION_EXISTS(strlcpy HAVE_STRLCPY)
  DCMTK_CHECK_FUNCTION_EXISTS(sysinfo HAVE_SYSINFO)
  DCMTK_CHECK_FUNCTION_EXISTS(uname HAVE_UNAME)
  DCMTK_CHECK_FUNCTION_EXISTS(usleep HAVE_USLEEP)
  DCMTK_CHECK_FUNCTION_EXISTS(waitpid HAVE_WAITPID)
