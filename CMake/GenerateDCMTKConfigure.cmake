...
IF(NOT DCMTK_ENABLE_CHARSET_CONVERSION)
  ...
  ELSEIF(DCMTK_WITH_GLIBC_ICONV)
    SET(DCMTK_ENABLE_CHARSET_CONVERSION "GNU C iconv" CACHE STRING "${DCMTK_ENABLE_CHARSET_CONVERSION_DOCSTRING}")
  ELSE()
...
ENDIF()
IF(DCMTK_WITH_GLIBC_ICONV)
  LIST(APPEND DCMTK_ENABLE_CHARSET_CONVERSION_ALTERNATIVES "GNU C iconv")
ENDIF()
...
ELSEIF(DCMTK_ENABLE_CHARSET_CONVERSION STREQUAL "GNU C iconv" OR DCMTK_ENABLE_CHARSET_CONVERSION STREQUAL "DCMTK_CHARSET_CONVERSION_GLIBC_ICONV")
  MESSAGE(STATUS "Info: Building DCMTK with character set conversion support using builtin iconv functions from the GNU C library")
  SET(DCMTK_ENABLE_CHARSET_CONVERSION "DCMTK_CHARSET_CONVERSION_GLIBC_ICONV")
ELSE()
