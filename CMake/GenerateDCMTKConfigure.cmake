...
ENDIF(WIN32 AND NOT CYGWIN)
  ...
  CHECK_FUNCTIONWITHHEADER_EXISTS(_fpclassf "${HEADERS}" HAVE_PROTOTYPE__FPCLASSF)
...
FUNCTION(INSPECT_FUNDAMENTAL_ARITHMETIC_TYPES)
  TRY_RUN(
    RESULT COMPILED
    ${CMAKE_BINARY_DIR}/CMakeTmp/Arith
    ${DCMTK_SOURCE_DIR}/config/arith.cc
    COMPILE_DEFINITIONS -I"${CMAKE_BINARY_DIR}/config/include" -I"${DCMTK_SOURCE_DIR}/ofstd/include"
    RUN_OUTPUT_VARIABLE OUTPUT
    COMPILE_OUTPUT_VARIABLE CERR
    ARGS "${CMAKE_BINARY_DIR}/config/include/dcmtk/config/arith.h"
  )
  IF(COMPILED)
    IF(NOT RESULT)
