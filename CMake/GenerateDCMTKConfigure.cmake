...
FUNCTION(DCMTK_TEST_ENABLE_CXX11)
  ...
  IF(DCMTK_ENABLE_CXX11)
    ...
    ELSE()
      ...
      TRY_COMPILE(COMPILE_RESULT "${CMAKE_BINARY_DIR}" "${CMAKE_CURRENT_SOURCE_DIR}/config/tests/cxx11.cc")
...
FUNCTION(DCMTK_TEST_ENABLE_STL_FEATURE NAME)
  ...
  IF(DCMTK_ENABLE_STL_${FEATURE} STREQUAL "ON")
    ...
    ELSE()
      ...
      MESSAGE(STATUS "${MESSAGE}")
      DCMTK_TRY_RUN(RUN_RESULT COMPILE_RESULT "${CMAKE_BINARY_DIR}" "${CMAKE_CURRENT_SOURCE_DIR}/config/tests/${SOURCEFILE}.cc")
