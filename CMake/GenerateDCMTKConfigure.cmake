...
# XML
IF(DCMTK_WITH_XML AND WITH_LIBXMLINC)
  SET(WITH_LIBXML 1)
  MESSAGE(STATUS "Info: DCMTK XML support will be enabled")
ELSE(DCMTK_WITH_XML AND WITH_LIBXMLINC)
  SET(WITH_LIBXML "")
  MESSAGE(STATUS "Info: DCMTK XML support will be disabled")
ENDIF(DCMTK_WITH_XML AND WITH_LIBXMLINC)

# PNG
IF(DCMTK_WITH_PNG AND WITH_LIBPNGINC)
  SET(WITH_LIBPNG 1)
  MESSAGE(STATUS "Info: DCMTK PNG support will be enabled")
ELSE(DCMTK_WITH_PNG AND WITH_LIBPNGINC)
  MESSAGE(STATUS "Info: DCMTK PNG support will be disabled")
ENDIF(DCMTK_WITH_PNG AND WITH_LIBPNGINC)

# TIFF
IF(DCMTK_WITH_TIFF AND WITH_LIBTIFFINC)
  SET(WITH_LIBTIFF 1)
  MESSAGE(STATUS "Info: DCMTK TIFF support will be enabled")
ELSE(DCMTK_WITH_TIFF AND WITH_LIBTIFFINC)
  SET(WITH_LIBTIFF "")
  MESSAGE(STATUS "Info: DCMTK TIFF support will be disabled")
ENDIF(DCMTK_WITH_TIFF AND WITH_LIBTIFFINC)

# ZLIB
IF(DCMTK_WITH_ZLIB AND WITH_ZLIBINC)
  SET(WITH_ZLIB 1)
  MESSAGE(STATUS "Info: DCMTK ZLIB support will be enabled")
ELSE(DCMTK_WITH_ZLIB AND WITH_ZLIBINC)
  SET(WITH_ZLIB "")
  MESSAGE(STATUS "Info: DCMTK ZLIB support will be disabled")
ENDIF(DCMTK_WITH_ZLIB AND WITH_ZLIBINC)

# OPENSSL
IF(DCMTK_WITH_OPENSSL AND WITH_OPENSSLINC)
  SET(WITH_OPENSSL 1)
  MESSAGE(STATUS "Info: DCMTK OPENSSL support will be enabled")
ELSE(DCMTK_WITH_OPENSSL AND WITH_OPENSSLINC)
  SET(WITH_OPENSSL "")
  MESSAGE(STATUS "Info: DCMTK OPENSSL support will be disabled")
ENDIF(DCMTK_WITH_OPENSSL AND WITH_OPENSSLINC)
