...
IF(WIN32 AND NOT CYGWIN AND NOT MINGW)
  ...
  SET(DCM_DICT_DEFAULT_PATH "${DCMTK_PREFIX}${DCMTK_INSTALL_DATDIR}${PATH_SEPARATOR}dicom.dic")
  # If private dictionary should be utilized, add it to default dictionary path.
  IF(WITH_PRIVATE_TAGS)
    SET(DCM_DICT_DEFAULT_PATH "${DCM_DICT_DEFAULT_PATH}${ENVIRONMENT_PATH_SEPARATOR}${DCMTK_PREFIX}${DCMTK_INSTALL_DATDIR}${PATH_SEPARATOR}private.dic")
...
ELSE(WIN32 AND NOT CYGWIN AND NOT MINGW)
  ...
  ENDIF(WITH_PRIVATE_TAGS)
  # Set default directory for configuration and support data.
  SET(DCMTK_DEFAULT_CONFIGURATION_DIR "${DCMTK_PREFIX}${DCMTK_INSTALL_ETCDIR}${PATH_SEPARATOR}")
  SET(DCMTK_DEFAULT_SUPPORT_DATA_DIR "${DCMTK_PREFIX}${DCMTK_INSTALL_DATDIR}${PATH_SEPARATOR}")
