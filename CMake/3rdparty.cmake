...
if(DCMTK_USE_FIND_PACKAGE)
  ...
  if(DCMTK_WITH_GROK)
    ...
    if(PKG_CONFIG_FOUND)
      pkg_check_modules(GROK QUIET libgrokj2k>=20.3.0)
    endif()
    if(NOT GROK_FOUND)
      message(STATUS "Warning: Grok JPEG 2000 support will be disabled because libgrokj2k was not found.")
      set(WITH_GROK "")
      set(DCMTK_WITH_GROK OFF CACHE BOOL "" FORCE)
    else()
      message(STATUS "Info: DCMTK Grok JPEG 2000 support will be enabled")
      set(WITH_GROK 1)
      include_directories(${GROK_INCLUDE_DIRS})
      set(GROK_INCDIR ${GROK_INCLUDE_DIRS})
      set(GROK_LIBS ${GROK_LIBRARIES})
      link_directories(${GROK_LIBRARY_DIRS})
    endif()
  endif()
