if(WIN32 AND NOT MINGW)
  ...
  if(DCMTK_WITH_ICONV)
    ...
    if(NOT LIBICONV_FOUND OR NOT LIBCHARSET_FOUND)
      ...
      message(STATUS "Info: DCMTK ICONV support will be enabled")
      set(WITH_LIBICONV 1)
      set(LIBICONV_INCDIR ${LIBICONV_INCLUDE_DIRS} ${Iconv_INCLUDE_DIRS} ${LIBCHARSET_INCLUDE_DIRS})
      set(LIBICONV_LIBDIR ${LIBICONV_LIBDIR})
      set(LIBICONV_LIBS ${LIBICONV_LIBRARIES} ${Iconv_LIBRARIES} ${LIBCHARSET_LIBRARY})
