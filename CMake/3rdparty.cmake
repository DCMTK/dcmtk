IF(WIN32)
  ...
  IF(DCMTK_WITH_XML)
    ...
    ELSE(WITH_LIBXMLINC) # turn off library if library path not set
      MESSAGE(STATUS "Warning: XML support will be disabled because libxml2 was not found at the specified directory. Correct path and re-enable DCMTK_WITH_XML.")
  ...
  IF(DCMTK_WITH_PNG)
    ...
    ELSE(WITH_LIBPNGINC) # turn off library if library path not set
      MESSAGE(STATUS "Warning: PNG support will be disabled because libpng was not found at the specified directory. Correct path and re-enable DCMTK_WITH_PNG.")
  ...
  IF(DCMTK_WITH_TIFF)
    ...
    ELSE(WITH_LIBTIFFINC) # turn off library if library path not set
      MESSAGE(STATUS "Warning: TIFF support will be disabled because libtiff was not found at the specified directory. Correct path and re-enable DCMTK_WITH_TIFF.")
 ...
 # OpenSSL support: configure compiler
  IF(DCMTK_WITH_OPENSSL)
    ...
    ELSE(WITH_OPENSSLINC) # turn off library if library path not set
      MESSAGE(STATUS "Warning: OPENSSL support will be disabled because libopenssl was not found at the specified directory. Correct path and re-enable DCMTK_WITH_OPENSSL.")
  ...
  IF(DCMTK_WITH_ZLIB)
    ...
    ELSE(WITH_ZLIBINC) # turn off library if library path not set
      MESSAGE(STATUS "Warning: ZLIB support will be disabled because zlib was not found at the specified directory. Correct path and re-enable DCMTK_WITH_ZLIB.")
...
IF (DCMTK_WITH_DOXYGEN)
  ...
  IF(NOT DOXYGEN_EXECUTABLE)
      MESSAGE(STATUS "Warning: doxygen enabled but not found, check doxygen installation!")
