...
#    SET(DCMTK_WITH_SNDFILE OFF CACHE BOOL "" FORCE)
  ...
  # Find libiconv
  IF(DCMTK_WITH_ICONV)
    # Make sure this option shows up in the GUI
    SET(LIBICONV_LIBDIR "${LIBICONV_LIBDIR}" CACHE PATH "Path to the iconv library")

    SET(LIBCHARSET_LIBS charset)
    FIND_LIBRARY(LIBCHARSET_LIBRARY NAMES ${LIBCHARSET_LIBS} HINTS ${LIBICONV_LIBDIR})
    MARK_AS_ADVANCED(LIBCHARSET_LIBRARY)
    IF(LIBCHARSET_LIBRARY)
      FIND_PACKAGE(ICONV)
