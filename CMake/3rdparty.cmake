...
if(NOT DCMTK_UNIFIED_FIND AND WIN32 AND NOT MINGW)
  ...
  if(DCMTK_WITH_TIFF)
    ...
    if(NOT TIFF_FOUND)
      ...
      if(NOT JPEG_FOUND)
        ...
        message(STATUS "Info: DCMTK TIFF support will be enabled")
        if(TARGET JPEG::JPEG)
          list(APPEND LIBTIFF_LIBS JPEG::JPEG)
        else()
  ...
  if(DCMTK_WITH_ICONV)
    ...
    if(NOT LIBICONV_FOUND OR NOT LIBCHARSET_FOUND)
      ...
      if(TARGET Iconv::Iconv)
        ...
        set(LIBICONV_INCDIR ${Iconv_INCLUDE_DIR} ${Iconv_INCLUDE_DIRS})
        set(LIBICONV_LIBS ${Iconv_LIBRARY} ${Iconv_LIBRARIES})
        include_directories(${LIBICONV_INCDIR})
      endif()

      if(TARGET Charset::Charset)
        list(APPEND LIBICONV_LIBS Charset::Charset)
      else()
        list(APPEND LIBICONV_LIBS ${LIBCHARSET_LIBRARIES})
        include_directories(${LIBCHARSET_INCLUDE_DIR})
      endif()
    endif()
  endif()
  ...
  if(DCMTK_WITH_WRAP)
    ...
    if(NOT WRAP_FOUND)
      ...
      if(TARGET Wrap::Wrap)
        list(APPEND WRAP_LIBS Wrap::Wrap)
      else()
