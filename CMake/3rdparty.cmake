...
IF(NOT DEFINED DCMTK_WITH_GLIBC_ICONV)
  INCLUDE(CheckCXXSourceCompiles)
  CHECK_CXX_SOURCE_COMPILES("#include <iconv.h>\nint main(){iconv_t cd = iconv_open(\"\",\"\");iconv(cd,0,0,0,0);iconv_close(cd);return 0;}" WITH_GLIBC_ICONV)
  IF(WITH_GLIBC_ICONV)
    MESSAGE(STATUS "Info: found builtin ICONV support inside the GNU C library.")
    SET(DCMTK_WITH_GLIBC_ICONV ON CACHE BOOL "" FORCE)
  ELSE(WITH_GLIBC_ICONV)
    SET(DCMTK_WITH_GLIBC_ICONV OFF CACHE BOOL "" FORCE)
  ENDIF(WITH_GLIBC_ICONV)
ENDIF(NOT DEFINED DCMTK_WITH_GLIBC_ICONV)
...
IF(DCMTK_WITH_ICONV OR DCMTK_WITH_GLIBC_ICONV)
  INCLUDE(CheckCXXSourceCompiles)
...
ENDIF(DCMTK_WITH_ICONV OR DCMTK_WITH_GLIBC_ICONV)
