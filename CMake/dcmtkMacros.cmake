...
MACRO(DCMTK_ADD_TESTS MODULE)
    IF(BUILD_APPS)
        ...
        FOREACH(TEST_LINE ${AVAIL_TESTS})
            ...
            ELSE()
                ADD_TEST("${TEST}" ${CMAKE_COMMAND} "-DDCMTK_CTEST_TESTCASE_COMMAND=${${MODULE}_TEST_CMD}" "-DDCMTK_CTEST_TEST_NAME=${TEST}" "-DDCMTK_CTEST_EXTRA_ARGUMENTS=\$ENV{DCMTK_CTEST_EXTRA_ARGUMENTS}" "-P" "${DCMTK_SOURCE_DIR}/CMake/CTest/dcmtkCTestRun.cmake" )
            ENDIF()
